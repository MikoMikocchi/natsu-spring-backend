...
class ReaderSettingServiceTest {
  ...
  @Mock private ReaderSettingRepository readerSettingRepository;
  ...
  void getOrCreateCreatesAndPersistsDefaultsWhenNoneExistYet() {
    ...
    when(readerSettingRepository.save(any(ReaderSetting.class)))
  ...
  void appliesAnUpdateWithTheSameTimestampAsStored() {
    ...
    ReaderSettingUpdateRequest sameTimestampRequest =
        new ReaderSettingUpdateRequest(24.0, null, null, null, 5000L);
  ...
  void createsDefaultSettingsBeforeApplyingAnUpdateWhenNoneExistYet() {
    ...
    ReaderSettingUpdateRequest request =
        new ReaderSettingUpdateRequest(22.0, null, Theme.DARK, null, 1000L);
