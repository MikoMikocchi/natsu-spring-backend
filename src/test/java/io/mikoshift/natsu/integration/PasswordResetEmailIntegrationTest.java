...
class PasswordResetEmailIntegrationTest {
    ...
    void forgotPasswordSendsResetEmailContainingTheLink() throws Exception {
        ...
        assertThat(message.getFrom()).extracting(Object::toString).containsExactly("noreply@natsu.example");
    ...
    void forgotPasswordSendsNoEmailForUnknownAddress() throws Exception {
        ...
        Thread.sleep(200);
        assertThat(greenMail.getReceivedMessages()).noneMatch(message -> containsRecipient(message, email));
    }
