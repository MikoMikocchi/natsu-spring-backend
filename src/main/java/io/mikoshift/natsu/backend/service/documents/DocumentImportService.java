...
import io.mikoshift.natsu.backend.service.bookimport.BookImportOrchestrator;
import io.mikoshift.natsu.backend.service.bookimport.FormatDetector;
import io.mikoshift.natsu.backend.service.bookimport.ImportException;
...
public class DocumentImportService {
     ...
     * import must only start once that commit is visible -- kicking off the async call from
     * inside a still-open transaction here would race it against a connection that hasn't
     * committed yet.
     */
