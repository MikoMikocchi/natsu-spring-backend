...
/** Raised by {@link TermBankImportService} for a malformed archive; not translated to an API error shape, since this is a seed-time-only operation with no HTTP request behind it. */
