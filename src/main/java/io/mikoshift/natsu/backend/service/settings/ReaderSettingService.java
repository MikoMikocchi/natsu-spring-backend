...
public class ReaderSettingService {
     ...
     * already stored; an older update is a no-op and the current stored state is returned as-is, so
     * a client that was offline and is catching up can't clobber a newer value written elsewhere.
     */
    @Transactional
