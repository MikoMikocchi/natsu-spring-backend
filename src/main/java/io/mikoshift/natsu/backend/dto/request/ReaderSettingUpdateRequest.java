...
/**
 * All fields except {@code updatedAtMs} are optional (partial update); only the fields present
 * are changed, and the whole update is dropped if {@code updatedAtMs} is older than what's
 * already stored.
 */
